...
!! CALL ncheck(nf90_put_att(ncId,nf90_global,"timeMax", timeMax),ncfname) !!gwc nf90_global not liking integer (kind=8)
 CALL ncheck(nf90_put_att(ncId,nf90_global,"timeMax", float(timeMax)),ncfname) 
